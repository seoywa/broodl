  ...
  return (
    <div className='flex flex-col gap-2'>
      <div className='grid grid-cols-5 gap-4'>
        ...
        }} className='mr-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'><FontAwesomeIcon icon={faChevronLeft} /></button>
        ...
        <button onClick={() => {
            handleIncrementMonth(+1)
        }} className='ml-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'><FontAwesomeIcon icon={faChevronRight} /></button>
      </div>

      <div className='flex flex-col overflow-hidden gap-1 py-4 sm:py-6 md:py-10' >
        {[...Array(numRows).keys()].map((row, rowIndex) => {return (
